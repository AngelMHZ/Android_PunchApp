...
import com.example.punchd.android_punchapp.dummy.DummyContent;
 ...
 */
public class StoreListActivity extends AppCompatActivity implements OnClickListener {
    ...
    private TextView Txt;// fast view to see if the camera works
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scanBtn = (FloatingActionButton)findViewById(R.id.scanButton);
        scanBtn.setOnClickListener(this);

        View recyclerView = findViewById(R.id.store_list);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent){
        ...
        if(scanningResult != null){
            ...
            Txt.setText(scanFormat + scanContent);
        }
        else{
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(StoreDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(StoreDetailFragment.ARG_ITEM_ID, holder.mItem.id);
